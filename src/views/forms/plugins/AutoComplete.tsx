...
const filter = createFilterOptions<FilmFilter>();
...
export default function FrmAutocomplete() {
  const [valueControl, setValueControl] = React.useState<FilmFilter | null>(null);
            ...
            <Grid size={12}>
              <SubCard title="Creatable">
                <Autocomplete
                  fullWidth
                  value={value2}
                  onChange={(event, newValue: string | FilmFilter | null | undefined) => {
                  ...
                  filterOptions={(options: (string | FilmFilter)[], params: FilterOptionsState<string | FilmFilter>) => {
                    // Convert strings to FilmFilter objects before filtering
                    const filteredOptions: FilmFilter[] = options.map((option) => {
                    ...
                    return filtered as (string | FilmFilter)[];
                  }}
                  selectOnFocus
                  clearOnBlur
                  handleHomeEndKeys
                  ...
                  options={top100Films}
                  getOptionLabel={(option: string | FilmFilter) => {
            ...
            <Grid container direction="column" spacing={2}>
              ...
              <Grid size={12}>
                <Autocomplete
                  ...
                  id="controlled-demo"
                  value={valueControl}
                  onChange={(event: any, newValue: FilmFilter | null) => {
