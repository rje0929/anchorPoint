...
const LightTooltip = styled(({ className, ...other }: TooltipProps) => <MuiTooltip {...other} classes={{ popper: className }} />)(
  ({ theme }) => ({
...
const BootstrapTooltip = styled(({ className, ...other }: TooltipProps) => <MuiTooltip {...other} arrow classes={{ popper: className }} />)(
  ({ theme }) => ({
...
const HtmlTooltip = styled(({ className, ...other }: TooltipProps) => <MuiTooltip {...other} classes={{ popper: className }} />)(
  ({ theme }) => ({
    [`& .${tooltipClasses.tooltip}`]: {
...
const CustomWidthTooltip = styled(({ className, ...other }: TooltipProps) => <MuiTooltip {...other} classes={{ popper: className }} />)({
  [`& .${tooltipClasses.tooltip}`]: {
    maxWidth: 500
  }
});

const NoMaxWidthTooltip = styled(({ className, ...other }: TooltipProps) => <MuiTooltip {...other} classes={{ popper: className }} />)({
  [`& .${tooltipClasses.tooltip}`]: {
    maxWidth: 'none'
  }
});
