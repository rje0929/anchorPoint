...
// project imports
import StatementTableHeader from './StatementHeader';
...
export default function StatementTable({ rows }: { rows: Order[] }) {
    ...
    <>
      <TableContainer>
        <Table sx={{ minWidth: 750 }} aria-labelledby="tableTitle">
          <StatementTableHeader order={order} orderBy={orderBy} onRequestSort={handleRequestSort} />
          <TableBody>
